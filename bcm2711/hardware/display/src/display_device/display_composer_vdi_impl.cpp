...
{
    DISPLAY_LOGE("%s GetDisplayProperty is not supported", __func__);
...
{
    DISPLAY_LOGE("%s SetDisplayClientCrop is not supported", __func__);
    return HDF_ERR_NOT_SUPPORT;
}
...
{
    DISPLAY_LOGE("%s SetDisplayClientDamage is not supported", __func__);
    return HDF_ERR_NOT_SUPPORT;
}
...
{
    DISPLAY_LOGE("%s SetLayerVisibleRegion is not supported", __func__);
    return HDF_ERR_NOT_SUPPORT;
}
...
{
    DISPLAY_LOGE("%s SetLayerMaskInfo is not supported", __func__);
    return HDF_ERR_NOT_SUPPORT;
}
...
int32_t DisplayComposerVdiImpl::SetLayerColor(uint32_t devId, uint32_t layerId, const LayerColor& layerColor)
{
    ...
    DISPLAY_LOGE("%s SetLayerColor is not supported", __func__);
    return HDF_ERR_NOT_SUPPORT;
}
